...
void initState(){
  ...
  Widget build(BuildContext context) {
    ...
    color: Color.fromARGB(255, 145, 135, 206), //change your color here
      ...
      centerTitle: true,
      title: TextField(
        style: TextStyle(color: Color.fromARGB(250, 153, 144, 210), fontFamily: "OpenSans-SemiBold", fontSize: 22),
        cursorColor: Color.fromARGB(250, 153, 144, 210),
        
        decoration: const InputDecoration(
          hintStyle: TextStyle(color: Color.fromARGB(250, 153, 144, 210), fontFamily: "OpenSans-SemiBold", fontSize: 22),
          hintText: "Название",
        ),
    ...
    color:Color.fromARGB(255, 145, 135, 206), //change your color here
      ...
      title: Text(title[selectedIndex], style: TextStyle(color: Color.fromARGB(250, 153, 144, 210), fontFamily: "OpenSans-SemiBold", fontSize: 22),),
      centerTitle: true,
      actions: [
        IconButton(
            onPressed: () {
  ...
  appBar: selectedIndex == 0 ? (tittleAppBar ? appBarSearch : appBar) : deffaultAppBar ,
	  ...
	  child: SizedBox(height: 60, child: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(
            ...
            icon: Icon(Icons.people_outline_outlined, color:  Color.fromARGB(255, 145, 135, 206), size: 35),
            label: '',
          ...
          BottomNavigationBarItem(
            ...
            icon: Icon(Icons.add, color:  Color.fromARGB(255, 145, 135, 206), size: 40,),
            label: '',
          ...
          BottomNavigationBarItem(
            ...
            icon: Icon(Icons.person_outline_outlined, color:  Color.fromARGB(255, 145, 135, 206), size: 35),
            label: '',
