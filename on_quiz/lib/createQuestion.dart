                          ...
                          if (quesIndex == 0) {
                            ...
                            setState(() {
                              ...
                              discriptionController.text = activeQuiz
                                  .questions[quesIndex - 1].discription!;
                              FirstAnswerController.text = activeQuiz
                                  .questions[quesIndex - 1].answerOne!;
                              SecondAnswerController.text = activeQuiz
                                  .questions[quesIndex - 1].answerTwo!;
                              ThreeAnswerController.text = activeQuiz
                                  .questions[quesIndex - 1].answerThree!;
                              FourAnswerController.text = activeQuiz
                                  .questions[quesIndex - 1].answerFour!;
                            });
                          }
                        }),
                  ),
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        if (discriptionController.text != "" &&
                          ...
                          if (activeQuiz.questions.length < questionsCount!) {
                          ...
                          if (CorrectAnswerController == "Вариант 1") {
                            activeQuiz.questions[quesIndex] = (new Question(
